      ...
      <div className="w-full  mt-14 md:mt-20 lg:mt-28 xl:mt-36 pr-3 md:pr-4 lg:pr-8">
            ...
            <div className="bg-[#7A35C1]  w-full rounded-xl py-12 md:py-26 lg:py-20 xl:py-24 px-5 md:px-8 lg:px-12 lg:rounded-2xl relative overflow-hidden items-center justify-center flex flex-col gap-6 md:gap-7 lg:gap-10">
                      <div className="flex flex-col gap-2 md:gap-3 lg:gap-4 xl:gap-5 z-20">
                        ...
                        <h1 className="text-[#FFF] text-center font-[Switzer] text-xl md:text-2xl lg:text-4xl xl:text-4xl font-bold leading-[140%]">Ready to Start Earning?</h1>
                        <p className=" text-[#FFF] text-center font-[Switzer] max-w-2xl text-sm lg:text-base font-normal leading-[140%]">Maxtron Innovations is growing fast—and we want you to grow with us. Join today and turn your business influence into real revenue.</p>
                      </div>
                      <Link to={"/contact"} className="flex justify-between items-center  gap-2 sm:gap-3 md:gap-4 lg:gap-6 xl:gap-7 border-[#FFF] ] px-3 md:px-4 lg:px-7 py-2 md:py-3 lg:py-3 rounded-[38px] border-2 border-solid z-20 hover:bg-[#FFF] transition-all duration-300 group">
                        <p className="text-[#fff] group-hover:text-[#7A35C1] text-center font-[Switzer] text-[12px] sm:text-sm md:text-base lg:text-lg font-normal leading-[140%]  transition-colors duration-300">Join the Maxtron Affiliate Program Now</p>
